...
export CARLA_ROOT=/e/ANTI-CARLA/CARLA_0.9.10
export PROJECT_PATH=/e/ANTI-CARLA
export utils_route=/e/ANTI-CARLA/utils
...
for (( j=0; j<=$end-1; j++ ))
  do
    ...
    do
        l=$x
        k=$x
        py -3.7 scene_generator/interpreter.py \
        ...
        py -3.7 ${LEADERBOARD_ROOT}/leaderboard/leaderboard_evaluator.py \
        --scenarios=${SCENARIOS}  \
        --routes=${ROUTES} \
